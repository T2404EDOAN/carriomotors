...
import "../../assets/styles/AbouContacus.css";
...
const ContactUs = () => {
  return (
    <div className="contact-header-container">
      ...
      <p>
        Looking for a quick answer? Check out our <a href="#">FAQ page</a>. If
        you don’t find what you’re looking for, please contact us using one of
        the methods below.
      </p>
      ...
      <div className="owners-section">
        ...
        <div className="owners-boxes">
          ...
          <div className="owners-box">
            ...
            <p>
              Safety and emission recall information is available 24 hours a
              day, by phone or online.
            </p>
            <p>
              <strong>1-800-525-7417</strong>
            </p>
